...
#    -e PASSWORD=pwd \                   # set rstudio password - user is rstudio
#    -v $BASE_DIR:/home/user/ \       # mount base directory (with Data and Analysis subdirectories) to pick up changes or write to host
#       rstudio/hello-world                  # the name of the image

# simple one liner for command line copying
BASE_DIR=${PWD}
sudo docker run -d --rm -p 28787:8787 --name hello-world -e PASSWORD=pwd -v $BASE_DIR:/home/user/ rstudio/hello-world

# this is an example of running the container in interactive mode and logging into a bash shell
# sudo docker run -it --rm  --name hello-world2 -e PASSWORD=pwd -v $BASE_DIR:/home/user/ rstudio/hello-world  /bin/bash
